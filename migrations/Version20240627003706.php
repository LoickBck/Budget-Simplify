 ...
 */
final class Version20240627003706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD author_id INT NOT NULL, DROP author');
        ...
        $this->addSql('ALTER TABLE comment CHANGE text content LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE content text LONGTEXT NOT NULL');
    }
}
